        ...
        <tr key={i}>
            <td className={`${Text}`}>
                <div className='w-12 p-1 bg-dry border border-border h-12 rounded overflow-hidden'>
                    <img src={movie.titleImg} alt={movie.name}
            ...
            <td className={`${Text} float-end flex-rows gap-2`}>
                {
                    admin ? (
                        <>
                        ...
                        <Link to={`/movie/${movie.name}`} className='bg-subMain rounded flex-colo w-6 h-6 text-white'>
                             <GoEye/>
                        </Link>
                        </>
                    )
        ...
        <table className='w-full table-auto border border-border divide-y divide-border'>
            <thead>
                <tr className='bg-dryGray'>
                    ...
                    <th scope="col" className={`${Head}`}>Years</th>
